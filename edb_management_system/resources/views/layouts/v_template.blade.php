...
<head>
    ...
    <meta charset="utf-8" />
    <title>EDB :: Engineering Development Board</title>
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="#">
            <div class="text-primary">
                <h3>Engineering Development Board</h3>
            </div>
        </a>
        <!--end::Logo-->
        <!--begin::Toolbar-->
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <!--end::Aside-->
            <!--begin::Wrapper-->
            <div class="d-flex flex-column flex-row-fluid wrapper" style="padding-top: 65px" id="kt_wrapper">
                <!--begin::Header-->
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href="#" class="text-dark-75 text-hover-primary">Carbon8 | Engineering Development
                                Board</a>
                        </div>
                        <!--end::Copyright-->
                    </div>
