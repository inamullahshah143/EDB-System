...
<!-- Modal-->
<div class="modal fade" id="modal-apply-amendment" data-backdrop="static" tabindex="-1" role="dialog"
...
@push('scripts')
    <script>
        $('document').ready(function() {
            ...
            // initialize btn add
            $('#applyAmendment').click(function() {
                $('#modal-apply-amendment').modal('show');
            });
