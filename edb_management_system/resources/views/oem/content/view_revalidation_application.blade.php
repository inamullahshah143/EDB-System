        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex">
                    ...
                    <button class="btn btn-sm btn-pill btn-outline-primary font-weight-bolder col-sm-2" id="applyRevalidation">
...
<!-- Modal-->
<div class="modal fade" id="modal-apply-revalidation" data-backdrop="static" tabindex="-1" role="dialog"
...
@push('scripts')
    <script>
        $('document').ready(function() {
            ...
            // initialize btn add
            $('#applyRevalidation').click(function() {
                $('#modal-apply-revalidation').modal('show');
            });
